...
*Ideias mapeadas para implementa��es futuras a pedido do usu�rio.*

- **Hero Carousel / Altern�ncia de V�deos:** Na se��o principal da Home (Hero), implementar um sistema de carrossel de v�deos em background. A ideia � ter 2 ou mais v�deos (al�m do atual) que fiquem se alternando a cada 24 horas (Video of the Day / V�deo da Semana), para que a loja sempre traga um ar de novidade para clientes recorrentes, sem causar distra��o com v�deos mudando enquanto a pessoa navega..
