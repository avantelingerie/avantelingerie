...
- **Regra de Ouro (Consulta Hist�rica):** Antes de propor qualquer solu��o arquitetural, realizar uma modifica��o importante no c�digo ou dar uma resposta conclusiva, a Ada deve obrigatoriamente ler o arquivo MEMORIA_TECNICA.md. O objetivo � validar se a a��o proposta n�o entra em conflito com decis�es estruturais e alinhamentos j� estabelecidos anteriormente no projeto.
