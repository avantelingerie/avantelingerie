...
export default function OrderSummary({ subtotal, discount, total, pixEligible, nextTierInfo, onCheckout, resellerSaving }) {
  ...
  return (
    <div className="bg-card border border-primary/10 rounded-2xl p-6 shadow-sm">
      ...
      {resellerSaving > 0 && (
        <div className="bg-[#E8F5E9] border border-[#81C784] rounded-xl p-3.5 mb-6 flex items-start gap-2.5 shadow-sm text-[#2E7D32]">
          <Zap className="w-5 h-5 text-[#4CAF50] shrink-0 mt-0.5" fill="currentColor" />
