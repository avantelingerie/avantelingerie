        ...
        <TableBody>
          {clientes.map((cliente) => (
            ...
            >
              ...
              <TableCell>
                {cliente.tipo_cliente === 'revendedor' && cliente.account_level !== 'verified' ? (
                  ...
                  <Badge className="bg-orange-500 hover:bg-orange-600 text-white capitalize border-orange-500 font-semibold shadow-sm">
                    Aprovado B2B
                  </Badge>
                ) : (
                  <Badge variant="outline" className="capitalize text-gray-400">
