                      ...
                      <div className="flex items-center gap-3">
                        <div className="w-10 h-10 rounded-md border bg-muted flex items-center justify-center overflow-hidden shrink-0">
                          {produto.imagem_principal || (produto.gallery && produto.gallery[0]) ? (
                            getProductImage(produto, produto.imagem_principal || produto.gallery[0]).match(/\.(mp4|webm|mov)$/i) ? (
                              <video src={getProductImage(produto, produto.imagem_principal || produto.gallery[0])} className="w-full h-full object-cover" muted playsInline />
                            ) : (
