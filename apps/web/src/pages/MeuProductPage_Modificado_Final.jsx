      ...
      <div className="container-custom py-8 md:py-12">
        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
          ...
          <div className="flex flex-col md:flex-row-reverse gap-4 lg:sticky lg:top-24 h-fit">
            ...
            <div className="flex md:flex-col gap-3 overflow-x-auto md:overflow-y-auto no-scrollbar py-1 md:py-0 md:pr-2 lg:max-h-[600px] xl:max-h-[700px] scroll-smooth">
          ...
          <div className="flex flex-col space-y-8">
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                ...
                <div className="flex items-center gap-1 bg-gray-900 text-white px-2 py-1 rounded-full text-xs font-medium">
            ...
            {/* Benefícios Dinâmicos (Carousel) */}
            <div className="pt-6 relative"
              onMouseEnter={() => setIsBenefitsHovered(true)}
              onMouseLeave={() => setIsBenefitsHovered(false)}
            >
              <div className="absolute inset-0 bg-gradient-to-r from-[#c59b5f]/5 via-transparent to-[#c59b5f]/5 rounded-3xl" />
              <Carousel setApi={setBenefitsApi} className="w-full relative z-10" opts={{ loop: true, align: 'start' }}>
                <CarouselContent>
                  <CarouselItem>
                    <div className="flex items-center gap-4 p-4">
                      <div className="w-12 h-12 rounded-2xl bg-[#c59b5f]/10 flex items-center justify-center shrink-0 border border-[#c59b5f]/20">
                        <Truck className="w-6 h-6 text-[#c59b5f]" />
                      </div>
                      <div>
                        <h4 className="text-sm font-bold text-gray-900 mb-0.5">Envio Expresso Privado</h4>
                        <p className="text-xs text-gray-500 font-medium">Embalagem 100% discreta e perfumada. Entrega rápida em todo Brasil.</p>
                      </div>
                    </div>
                  </CarouselItem>
                  <CarouselItem>
                    <div className="flex items-center gap-4 p-4">
                      <div className="w-12 h-12 rounded-2xl bg-[#c59b5f]/10 flex items-center justify-center shrink-0 border border-[#c59b5f]/20">
                        <CheckCircle2 className="w-6 h-6 text-[#c59b5f]" />
                      </div>
                      <div>
                        <h4 className="text-sm font-bold text-gray-900 mb-0.5">Qualidade Premium</h4>
                        <p className="text-xs text-gray-500 font-medium">Rendas antialérgicas francesas, toque macio que não irrita a pele.</p>
                      </div>
                    </div>
                  </CarouselItem>
                  <CarouselItem>
                    <div className="flex items-center gap-4 p-4">
                      <div className="w-12 h-12 rounded-2xl bg-[#c59b5f]/10 flex items-center justify-center shrink-0 border border-[#c59b5f]/20">
                        <RefreshCw className="w-6 h-6 text-[#c59b5f]" />
                      </div>
                      <div>
                        <h4 className="text-sm font-bold text-gray-900 mb-0.5">Troca Facilitada</h4>
                        <p className="text-xs text-gray-500 font-medium">Primeira troca grátis em até 7 dias, sem burocracia.</p>
                      </div>
                    </div>
                  </CarouselItem>
                </CarouselContent>
              ...
              <div className="flex justify-center gap-1.5 mt-2">
                {benefitSnaps.map((_, index) => (
                  <button
                    key={index}
                    className={`h-1.5 rounded-full transition-all duration-300 ${index === currentBenefitSlide ? 'bg-[#c59b5f] w-6' : 'bg-gray-200 w-1.5 hover:bg-gray-300'}`}
            ...
            {/* Accordion de Detalhes com Design Premium */}
            <div className="pt-8">
              
              <Tabs defaultValue="geral" className="w-full">
                <TabsList className="w-full justify-start border-b border-gray-200 rounded-none bg-transparent h-auto p-0 mb-6 gap-6 overflow-x-auto no-scrollbar">
                  {product?.desc_geral && (
                    <TabsTrigger value="geral" className="data-[state=active]:bg-transparent data-[state=active]:shadow-none data-[state=active]:border-b-2 data-[state=active]:border-[#c59b5f] data-[state=active]:text-[#c59b5f] rounded-none px-0 py-3 font-bold text-sm text-gray-500 hover:text-gray-900 transition-colors uppercase tracking-wider whitespace-nowrap">
                      Geral
                    </TabsTrigger>
                  )}
                  {product?.desc_tecido && (
                    <TabsTrigger value="tecido" className="data-[state=active]:bg-transparent data-[state=active]:shadow-none data-[state=active]:border-b-2 data-[state=active]:border-[#c59b5f] data-[state=active]:text-[#c59b5f] rounded-none px-0 py-3 font-bold text-sm text-gray-500 hover:text-gray-900 transition-colors uppercase tracking-wider whitespace-nowrap">
                      Tecido
                    </TabsTrigger>
                  )}
                  {product?.desc_modelagem && (
                    <TabsTrigger value="modelagem" className="data-[state=active]:bg-transparent data-[state=active]:shadow-none data-[state=active]:border-b-2 data-[state=active]:border-[#c59b5f] data-[state=active]:text-[#c59b5f] rounded-none px-0 py-3 font-bold text-sm text-gray-500 hover:text-gray-900 transition-colors uppercase tracking-wider whitespace-nowrap">
                      Modelagem
                    </TabsTrigger>
                  )}
                  {product?.desc_cuidados && (
                    <TabsTrigger value="cuidados" className="data-[state=active]:bg-transparent data-[state=active]:shadow-none data-[state=active]:border-b-2 data-[state=active]:border-[#c59b5f] data-[state=active]:text-[#c59b5f] rounded-none px-0 py-3 font-bold text-sm text-gray-500 hover:text-gray-900 transition-colors uppercase tracking-wider whitespace-nowrap">
                      Cuidados
                    </TabsTrigger>
                  )}
                  {product?.desc_diferenciais && (
                    <TabsTrigger value="diferenciais" className="data-[state=active]:bg-transparent data-[state=active]:shadow-none data-[state=active]:border-b-2 data-[state=active]:border-[#c59b5f] data-[state=active]:text-[#c59b5f] rounded-none px-0 py-3 font-bold text-sm text-gray-500 hover:text-gray-900 transition-colors uppercase tracking-wider whitespace-nowrap">
                      Diferenciais
                    </TabsTrigger>
                  )}
                  {product?.desc_compra_segura && (
                    <TabsTrigger value="compra_segura" className="data-[state=active]:bg-transparent data-[state=active]:shadow-none data-[state=active]:border-b-2 data-[state=active]:border-[#c59b5f] data-[state=active]:text-[#c59b5f] rounded-none px-0 py-3 font-bold text-sm text-gray-500 hover:text-gray-900 transition-colors uppercase tracking-wider whitespace-nowrap">
                      Compra Segura
                    </TabsTrigger>
                  )}
                </TabsList>
                ...
                {product?.desc_geral && (
                  <TabsContent value="geral" className="animate-in fade-in duration-500 pt-2">
                    <p className="whitespace-pre-line text-gray-600 font-light leading-relaxed">{product.desc_geral}</p>
                  </TabsContent>
                )}
                {product?.desc_tecido && (
                  <TabsContent value="tecido" className="animate-in fade-in duration-500 pt-2">
                    <p className="whitespace-pre-line text-gray-600 font-light leading-relaxed">{product.desc_tecido}</p>
                  </TabsContent>
                )}
                {product?.desc_modelagem && (
                  <TabsContent value="modelagem" className="animate-in fade-in duration-500 pt-2">
                    <p className="whitespace-pre-line text-gray-600 font-light leading-relaxed">{product.desc_modelagem}</p>
                  </TabsContent>
                )}
                {product?.desc_cuidados && (
                  <TabsContent value="cuidados" className="animate-in fade-in duration-500 pt-2">
                    <p className="whitespace-pre-line text-gray-600 font-light leading-relaxed">{product.desc_cuidados}</p>
                  </TabsContent>
                )}
                {product?.desc_diferenciais && (
                  <TabsContent value="diferenciais" className="animate-in fade-in duration-500 pt-2">
                    <p className="whitespace-pre-line text-gray-600 font-light leading-relaxed">{product.desc_diferenciais}</p>
                  </TabsContent>
                )}
                {product?.desc_compra_segura && (
                  <TabsContent value="compra_segura" className="animate-in fade-in duration-500 pt-2">
                    <p className="whitespace-pre-line text-gray-600 font-light leading-relaxed">{product.desc_compra_segura}</p>
                  </TabsContent>
                )}
              </Tabs>

            {/* Ícones de Confiança Premium */}
            <div className="grid grid-cols-3 gap-3 mt-8 pt-8 border-t border-gray-100/60">
              <div className="flex flex-col items-center justify-center text-center p-4 rounded-3xl bg-gradient-to-b from-white to-gray-50/80 border border-gray-100 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.03)] hover:shadow-[0_8px_25px_-6px_rgba(197,155,95,0.15)] hover:border-[#c59b5f]/20 hover:-translate-y-1 transition-all duration-300 group cursor-default">
                <div className="w-12 h-12 rounded-2xl bg-[#c59b5f]/5 flex items-center justify-center mb-3 group-hover:bg-[#c59b5f]/10 transition-colors duration-300">
                  <Shield className="w-6 h-6 text-[#c59b5f]" />
                </div>
                <span className="text-[10px] sm:text-xs font-bold text-gray-900 uppercase tracking-widest leading-tight">Compra<br/>Segura</span>
              </div>
              <div className="flex flex-col items-center justify-center text-center p-4 rounded-3xl bg-gradient-to-b from-white to-gray-50/80 border border-gray-100 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.03)] hover:shadow-[0_8px_25px_-6px_rgba(197,155,95,0.15)] hover:border-[#c59b5f]/20 hover:-translate-y-1 transition-all duration-300 group cursor-default">
                <div className="w-12 h-12 rounded-2xl bg-[#c59b5f]/5 flex items-center justify-center mb-3 group-hover:bg-[#c59b5f]/10 transition-colors duration-300">
                  <RefreshCw className="w-6 h-6 text-[#c59b5f]" />
                </div>
                <span className="text-[10px] sm:text-xs font-bold text-gray-900 uppercase tracking-widest leading-tight">Troca<br/>Fácil</span>
              </div>
              <div className="flex flex-col items-center justify-center text-center p-4 rounded-3xl bg-gradient-to-b from-white to-gray-50/80 border border-gray-100 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.03)] hover:shadow-[0_8px_25px_-6px_rgba(197,155,95,0.15)] hover:border-[#c59b5f]/20 hover:-translate-y-1 transition-all duration-300 group cursor-default">
                <div className="w-12 h-12 rounded-2xl bg-[#c59b5f]/5 flex items-center justify-center mb-3 group-hover:bg-[#c59b5f]/10 transition-colors duration-300">
                  <Truck className="w-6 h-6 text-[#c59b5f]" />
                </div>
                <span className="text-[10px] sm:text-xs font-bold text-gray-900 uppercase tracking-widest leading-tight">Envio<br/>Rápido</span>
              </div>
            </div>
