      ...
      <div className="container-custom py-8 md:py-12">
        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
          ...
          <div className="flex flex-col md:flex-row-reverse gap-4 lg:sticky lg:top-24 h-fit">
            ...
            <div className="flex md:flex-col gap-3 overflow-x-auto md:overflow-y-auto no-scrollbar py-1 md:py-0 md:pr-2">
          ...
          <div className="flex flex-col space-y-8">
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                ...
                <span className="text-xs font-medium text-gray-400 bg-gray-100 px-3 py-1 rounded-full flex items-center gap-1.5">
                  <Hash className="w-3 h-3" />
                  {productReferencia}
                </span>
                <div className="flex items-center gap-1 bg-gray-900 text-white px-2 py-1 rounded-full text-xs font-medium ml-auto">
            ...
            <div className="pt-8">
              <Tabs defaultValue="detalhes" className="w-full">
                <TabsList className="w-full justify-start border-b border-gray-200 rounded-none bg-transparent h-auto p-0 mb-6 gap-6">
                  <TabsTrigger
                    value="detalhes"
                    className="data-[state=active]:bg-transparent data-[state=active]:shadow-none data-[state=active]:border-b-2 data-[state=active]:border-[#c59b5f] data-[state=active]:text-[#c59b5f] rounded-none px-0 py-3 font-bold text-sm text-gray-500 hover:text-gray-900 transition-colors uppercase tracking-wider"
                  >
                    Detalhes da Peça
                  </TabsTrigger>
                  <TabsTrigger
                ...
                <TabsContent value="detalhes" className="text-sm text-gray-600 leading-relaxed font-medium animate-in fade-in duration-500">
                  <div dangerouslySetInnerHTML={{ __html: productDescription }} className="prose prose-sm prose-p:leading-relaxed prose-a:text-[#c59b5f] prose-strong:text-gray-900 max-w-none" />
                </TabsContent>

                <TabsContent value="composicao" className="text-sm text-gray-600 leading-relaxed animate-in fade-in duration-500">
                  <div className="grid grid-cols-2 gap-4">
                    <div className="bg-white p-4 rounded-2xl border border-gray-100 shadow-sm flex items-start gap-3">
                      <Leaf className="w-5 h-5 text-[#c59b5f] mt-0.5" />
                      <div>
                        <span className="block font-bold text-gray-900 mb-1">Tecido Principal</span>
                        90% Poliamida<br />10% Elastano
                      </div>
                    </div>
                    <div className="bg-white p-4 rounded-2xl border border-gray-100 shadow-sm flex items-start gap-3">
                      <Wind className="w-5 h-5 text-[#c59b5f] mt-0.5" />
                      <div>
                        <span className="block font-bold text-gray-900 mb-1">Forro Íntimo</span>
                        100% Algodão<br />Respirável
                      </div>
                    </div>
                  </div>
                </TabsContent>

                <TabsContent value="cuidados" className="text-sm text-gray-600 leading-relaxed animate-in fade-in duration-500">
                  <ul className="space-y-3 bg-white p-5 rounded-2xl border border-gray-100 shadow-sm">
