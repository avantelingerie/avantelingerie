...
migrate((app) => {
  ...
  const record0 = new Record(collection);
    record0.set("name", "Conjunto em Microfibra Premium Cropped Regata");
    record0.set("description", "Eleg\u00e2ncia e conforto em uma \u00fanica pe\u00e7a. Cropped regata sofisticado que valoriza o corpo sem marcar.");
    record0.set("categoria", "CONJUNTOS");
    record0.set("reference", "AVL0002");
