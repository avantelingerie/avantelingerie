...
`;
    ...
    const modelo = precisaDeNuance ? 'claude-3-5-sonnet-20241022' : 'claude-3-5-haiku-20241022';
...
`;
    ...
    const modelo = 'claude-3-5-haiku-20241022'; // No WhatsApp usamos modelo rápido
