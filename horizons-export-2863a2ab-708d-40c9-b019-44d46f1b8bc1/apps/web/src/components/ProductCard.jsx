    ...
    <div className="group flex flex-col bg-white rounded-3xl border border-[#c59b5f]/15 overflow-hidden shadow-premium-sm hover:-translate-y-2 hover:shadow-premium hover:border-[#c59b5f]/40 transition-all duration-500 h-full w-full max-w-sm mx-auto relative">
      ...
      <div className="flex flex-col flex-1 p-4 md:p-5 bg-card">
        ...
        <div className="mt-auto flex flex-col gap-2">
          ...
          <button
            className="w-full bg-emerald-600 hover:bg-emerald-700 text-white flex justify-center items-center gap-1.5 py-2 rounded-xl text-[10px] font-bold uppercase tracking-wider transition-colors duration-300 shadow-sm cursor-pointer"
          ...
          <button
            className="w-full bg-emerald-800 hover:bg-emerald-955 text-white py-2 rounded-xl text-[10px] font-bold uppercase tracking-wider transition-colors duration-300 shadow-sm cursor-pointer"
            onClick={handleBuyClick}
          >
            {isReseller ? 'ATÉ 15% EXTRA PROGRESSIVO ATACADO' : 'ATÊ 20% OFF PROGRESSIVO'}
          </button>

          <div className="flex flex-col gap-1 my-1.5 bg-gray-55 p-2.5 rounded-xl border border-gray-100">
            <div className="text-emerald-600 text-[10px] sm:text-[11px] font-bold flex items-center gap-1.5">
              <Package size={12} className="shrink-0 text-emerald-500" />
              <span>Mais de {sold} vendidos essa semana!</span>
            </div>
            <div className="text-amber-500 text-[10px] sm:text-[11px] font-bold flex items-center gap-1.5">
              <Zap size={12} className="shrink-0 text-amber-500" />
              <span>Restam apenas {stock} unidades em estoque!</span>
            </div>
          </div>
