...
migrate((app) => {
  ...
  const record1 = new Record(collection);
    record1.set("name", "Conjunto em Microfibra Cropped Regata Gola Alta");
    record1.set("description", "Conforto que abra\u00e7a seu corpo e valoriza cada curva sem marcar.");
    record1.set("categoria", "CONJUNTOS");
    record1.set("price", 19.9);
    record1.set("avaliacao_media", 4.8);
    record1.set("vendidos_semana", 1200);
    record1.set("is_promocao", true);
    record1.set("is_novidade", false);
    record1.set("is_combo", false);
  try {
    app.save(record1);
  } catch (e) {
    if (e.message.includes("Value must be unique")) {
